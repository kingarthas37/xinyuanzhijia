...
router.get('/', function (req, res, next) {
    ...
    async.series([
        ...
        function () {
            res.render('order/purchase', data);
        }
...
router.get('/get-spider-info',(req,res)=> {
    ...
    var result = {title: '-', image: '//lc-JoaBcRTt.cn-n1.lcfile.com/d4c225054f005a4d7d39.png?imageMogr2/thumbnail/24'};
    var response = res;
