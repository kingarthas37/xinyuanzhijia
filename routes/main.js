...
module.exports = {
   ...
   // '/':require('./default/index'),
    ...
    '/order/spent/edit':require('./order/spent/edit'),
    ...
    '/order/purchase':require('./order/purchase'),
    '/order/purchase/add':require('./order/purchase/add'),
    '/order/purchase/edit':require('./order/purchase/edit'),
