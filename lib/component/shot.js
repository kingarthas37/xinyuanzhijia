...
module.exports = function(params,callback,error) {
    ...
    html += `<style>
    body { margin:0; width:750px; font-size:22px; font-weight: 100; line-height:38px; background: #fff; font-family:'Segoe UI','Lucida Grande','Helvetica','Arial','Microsoft YaHei'; } 
    section {  padding:0; margin:0 0 20px 0; } 
    div { padding:0 15px; margin-bottom: 20px;  } 
    ul {  margin:0 0 15px 0; padding: 0 0 0 20px; } 
    img { width: 100%; margin-bottom: 20px;} p { margin:0 0 15px 0; padding: 0; } 
    </style>`;
