...
module.exports = {
    ...
    getProducts(options, isCount){
        ...
        var cql = 'select objectId,isHandmade,tags,sales,category1,category2,name,productId,price,isOnsale,mainImage,pageViews,stock from Product where objectId != null';
        if (isCount) {
