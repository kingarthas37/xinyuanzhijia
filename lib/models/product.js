...
module.exports = {
    ...
    getProducts(options, isCount){
        ...
        if (!options.select) {
            options.select = 'objectId,isHandmade,tags,sales,category1,category2,name,productId,price,isOnsale,mainImage,pageViews,stock,isRefund,productMethod,purchaseLink,shopLink,groups'
        }
