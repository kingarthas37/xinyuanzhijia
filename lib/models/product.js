...
module.exports = {
    ...
    getProducts(options, isCount){
        ...
        if (options.isSales) {
            cql += ' and (isSales = 1 or isSales = 2 or isSales = 3)';
            order =  'order by isSales desc';
        }
        ...
        if (!isCount) {
            if (!options.parentProductId && !options.isSales) {
                if (options.price) {
