...
module.exports = {
    ...
    indexFun: function () {
        ...
        $('.ckb-shipping-status-shipped').click(function () {
            ...
            $.ajax({
                url: '/order/purchase/shipping-status',
                type: 'get',
                data: {
        ...
        $('#select-site-type').change(function () {
            if (this.value) {
                return location.href = '/order/purchase?site-type=' + this.value;
            }
            location.href = '/order/purchase';
        });

        $('.ckb-shipping-status').click(function () {
            if (this.checked) {
                location.href = `/order/purchase?shipping-status=${this.name}&site-type=${$("#site-type").val()}`;
            } else {
                location.href = '/order/purchase?site-type=' + $("#site-type").val();
            }
        });

        $('.import-order').click(function() {
            $.ajax({
                url: '/order/purchase/import-order',
                type: 'post',
                data: {
    ...
    purchaseTypeAhead: function () {
        ...
        purchaseDescription.typeahead(null, {
            ...
            source: new Bloodhound({
                ...
                remote: {
                    url: '/order/purchase/add/website-desc',
