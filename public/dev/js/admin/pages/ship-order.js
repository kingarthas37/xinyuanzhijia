    ...
    indexFun: function () {
        ...
        $('.remove-ship-order').click(function () {
            if(confirm('确认删除？')) {
                let id = $(this).data('id');
                $.ajax({
                    url:'/order/ship-order/remove/' + id,
                    method:'post',
                    success:function(data) {
                        location.reload();
                    }
        ...
        $('.ckb-is-haiguan').click(function () {
            ...
            $.ajax({
                url:`/order/ship-order/updateOrderStatus/${id}/${type}/${value}`,
                method:'post'
            }).done(function () {
                ...
                $(this).click(function () {
                    ...
                    modal.modal({
                        ...
                        onConfirm: function(e) {
                            ...
                            $.ajax({
                                url:`/order/ship-order/edit-tracking/${id}`,
                                type:'post',
                                data:{
            ...
            $('.edit-remark').click(function () {
                ...
                modal.modal({
                    ...
                    onConfirm: function(e) {
                        ...
                        $.ajax({
                            url:`/order/ship-order/edit-remark/${id}`,
                            type:'post',
                            data:{
                                value:$.trim(input.val())
                            },
            ...
            $('.edit-ship-order').click(function () {
                ...
                modal.modal({
                    ...
                    onConfirm: function(e) {
                        ...
                        $.ajax({
                            url:`/order/ship-order/edit-ship-order-number/${id}`,
                            type:'post',
                            data:{
                                value:$.trim(input.val())
                            },
        ...
        //查询快递
        {
            ...
            $('.am-table').on('click','.search-tracking',function () {
                ...
                $.ajax({
                    url:`/order/ship-order/express/${id}/${shipCode}`,
                    type:'get',
                    success:function(data) {
            ...
            $('.search-child-tracking').click(function() {
                ...
                table.find(`tr[parent-data-id=${parentId}]`).each(function(i,n){
                    ...
                    if($(n).find('.search-tracking').text().length) {
                        ...
                        $.ajax({
                            url:`/order/ship-order/express/${trackingNumber}/${shipCode}`,
                            type:'get',
                            success:function(data) {
                                if(!data.list) {
                                    td.popover({
